define(['imageannotation/config',
        ...
        'imageannotation/viewer/gridLayer',
        'imageannotation/viewer/annotationLayer'], function(Config, Events, GridLayer, AnnotationLayer) {
  ...
  var Viewer = function(divId, eventBroker) {
    var div = jQuery('#' + divId),
        ...
        gridLayer = new GridLayer(map, eventBroker);
